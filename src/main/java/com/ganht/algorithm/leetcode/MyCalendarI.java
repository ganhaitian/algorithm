...
public class MyCalendarI {
    ...
    static class MyCalendar {
        ...
        private final TreeSet<Range> books;
        ...
        public boolean book(int start, int end) {
            Range newBook = new Range();
            newBook.start = start;
            newBook.end   = end;
    
            Range preBook  = books.floor(newBook);
            Range nextBook = books.ceiling(newBook);
            if ((preBook == null || preBook.end <= start) && (nextBook == null || end <= nextBook.start)) {
                books.add(newBook);
                return true;
            }
